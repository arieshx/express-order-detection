...
from lib.fast_rcnn.bbox_transform import bbox_transform_inv, clip_boxes, bbox_transform_inv_hx
from lib.fast_rcnn.nms_wrapper import nms

"""
修改自proposal_layer_tf ,
"""
DEBUG = False
"""
...
"""
def proposal_layer(rpn_cls_prob_reshape, rpn_bbox_pred, rpn_side_refinement,  im_info, cfg_key, _feat_stride = [16,], anchor_scales = [16,]):
    """
    Parameters
    ----------
    rpn_cls_prob_reshape: (1 , H , W , Ax2) outputs of RPN, prob of bg or fg
                         NOTICE: the old version is ordered by (1, H, W, 2, A) !!!!
    rpn_bbox_pred: (1 , H , W , Ax2), 竖直方向归回出的偏差
    rpn_side_refinement: (1 , H , W , A*1), side -refinement
    ...
    bbox_v = rpn_bbox_pred#模型输出的pred是相对值，需要进一步处理成真实图像中的坐标
    bbox_o = rpn_side_refinement
    ...
    # reshape
    bbox_v = bbox_v.reshape((-1,2))
    bbox_o = bbox_o.reshape((-1))
    ...
    proposals = bbox_transform_inv_hx(anchors, bbox_v, bbox_o)
