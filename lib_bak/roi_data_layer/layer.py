...
class RoIDataLayer(object):
    ...
    def _shuffle_roidb_inds(self):
        ...
        # np.random.seed(1)  # fixed for debug locally
    ...
    def _get_next_minibatch(self):
        ...
        return db_inds,get_minibatch(minibatch_db, self._num_classes)
            
    def forward(self):
        """Get blobs and copy them into this layer's top blob vector."""
        db_inds,blobs = self._get_next_minibatch()
        return db_inds,blobs
